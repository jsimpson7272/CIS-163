...
public class ChangeJar {
    ...
    public ChangeJar(String amount){
        ...
        new ChangeJar(dubAmount);

        int quarters = (int) (dubAmount / .25);
        dubAmount = dubAmount - (quarters*.25);

        int dimes = (int) (dubAmount / .10);
        dubAmount = dubAmount - dimes * .10;

        int nickels = (int) (dubAmount / .05);
        dubAmount = dubAmount - nickels * .05;

        int pennies = (int) (dubAmount / .01);
        dubAmount = dubAmount - pennies * .01;
    ...
    public static boolean equals(ChangeJar jar1, ChangeJar jar2){
        if(jar1.equals(jar2)) return true;
        else{
            return false;
        }
...
//    }
    ...
    public static boolean equal(ChangeJar s, ChangeJar s1) {
        return true;
    }
